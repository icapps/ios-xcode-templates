...
class ___FILEBASENAMEASIDENTIFIER___: QuickSpec {
    override func spec() {
        describe("___VARIABLE_productName___Interactor") {
            ...
            var presenter: Mocked___VARIABLE_productName___PresentationLogic!
            
            beforeEach {
                presenter = Mocked___VARIABLE_productName___PresentationLogic()
            ...
            it("should pass the correct response") {
                let request = ___VARIABLE_productName___.Data.Request()
